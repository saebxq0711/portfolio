      ...
      <div className="max-w-8xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8 md:space-y-12 order-1 lg:order-2">
            ...
            >
              ...
              <div className="space-y-8 text-gray-tertiary text-lg leading-relaxed">
                <p className="relative pl-8">
                  <span className="absolute left-0 top-0 text-white-primary font-mono text-2xl">
                    "
                  </span>
                  Soy un desarrollador web apasionado con experiencia en el
                  ...
                  . Me especializo en crear aplicaciones web modernas,
                  escalables y centradas en el usuario.
                  <span className="absolute right-0 bottom-0 text-white-primary font-mono text-2xl">
                    "
                  </span>
                </p>

                <p>
                  Mi enfoque se basa en escribir{" "}
                  <span className="text-white-primary font-semibold">
                    código limpio
                  </span>
                  , implementar las mejores prácticas y mantenerme actualizado
                  con las últimas tecnologías del desarrollo web.
                </p>
              </div>
            </div>
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 transition-all duration-1000 delay-500 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            >
              {[
                ...
                <div
                  key={title}
                  className={`bg-black-tertiary border ${color} p-8 text-center hover-lift hover-glow transition-all duration-500 group stagger-${
                    index + 1
                  }`}
                >
                  <Icon className="w-12 h-12 text-white-primary mx-auto mb-6 group-hover:animate-bounce" />
                  <h4 className="font-black text-white-primary mb-3 tracking-widest text-lg">
                    {title}
                  </h4>
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 pt-8 md:pt-12 border-t border-gray-primary/20 transition-all duration-1000 delay-700 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            >
              {[
                ...
                <div
                  key={text}
                  className={`flex flex-col items-center space-y-3 group stagger-${
                    index + 1
                  }`}
                >
                  <Icon className="w-8 h-8 text-white-primary group-hover:animate-pulse" />
                  <div className="text-center">
                    <div className="text-gray-tertiary font-bold tracking-wide">
                      {text}
                    </div>
                    <div className="text-gray-secondary text-sm font-mono">
                      {subtext}
                    </div>
                  </div>
                </div>
