...
const projects = [
  ...
  },
  {
    ...
    description: "Sitio web de portafolio personal responsive con diseño moderno y animaciones suaves.",
    image: "https://via.placeholder.com/600x400/000000/ffffff?text=PORTFOLIO+SITE",
  ...
  },
  {
    ...
    description:
      "Sistema de gestión de contenidos para blog con panel de administración completo desarrollado con PHP y Laravel.",
    image: "https://via.placeholder.com/600x400/000000/ffffff?text=BLOG+CMS",
    technologies: ["PHP", "Laravel", "MySQL", "Bootstrap"],
    githubUrl: "https://github.com/tu-usuario/proyecto4",
    liveUrl: "https://tu-proyecto4.com",
    year: "2023",
    featured: true,
    status: "LIVE",
    views: "4.1K",
  },
  {
    ...
    description:
      "Aplicación del clima con geolocalización y pronósticos detallados, desarrollada con JavaScript vanilla.",
    image: "https://via.placeholder.com/600x400/000000/ffffff?text=WEATHER+APP",
    technologies: ["JavaScript", "HTML", "CSS", "API"],
    githubUrl: "https://github.com/tu-usuario/proyecto5",
    liveUrl: "https://tu-proyecto5.com",
    year: "2023",
    featured: false,
    status: "LIVE",
    views: "1.5K",
  },
  {
    ...
    description:
      "Dashboard interactivo para visualización de datos con gráficos dinámicos desarrollado con Python y React.",
    image: "https://via.placeholder.com/600x400/000000/ffffff?text=DATA+DASHBOARD",
    technologies: ["Python", "React", "SQL", "JavaScript"],
    githubUrl: "https://github.com/tu-usuario/proyecto6",
    liveUrl: "https://tu-proyecto6.com",
    year: "2023",
    featured: false,
    status: "DEV",
    views: "892",
